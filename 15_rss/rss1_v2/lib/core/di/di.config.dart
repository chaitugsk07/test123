...
import '../../data/04_sources/feed/article_feed_services.dart' as _i7;
import '../../data/04_sources/graphql/graphql_service.dart' as _i5;
import '../../data/06_repositories/feed/article_feed_repo.dart' as _i9;
import '../../data/08_usecases/usecases_module.dart' as _i10;
import '../../domain/05_repositories/feed/articles_feed_repo.dart' as _i8;
import '../../domain/07_usecases/get_article_feed_usecase.dart' as _i4;
import '../../presentation/feed/models/ui_article_feed_mapper.dart' as _i6;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt $initGetIt({
    ...
    gh.factory<_i6.UiAticleFeedListMapper>(() => _i6.UiAticleFeedListMapper());
    gh.factory<_i6.UiAticleFeedMapper>(() => _i6.UiAticleFeedMapper());
    gh.factory<_i3.ArticleFeedListMapper>(
        () => _i3.ArticleFeedListMapper(gh<_i3.ArticleFeedMapper>()));
    gh.factory<_i7.ArticleFeedServices>(
        () => _i7.ArticleFeedServices(gh<_i5.GraphQLService>()));
    gh.factory<_i8.ArticalsRss1Repository>(() => _i9.ArticalsRss1RepositoryImpl(
          gh<_i7.ArticleFeedServices>(),
