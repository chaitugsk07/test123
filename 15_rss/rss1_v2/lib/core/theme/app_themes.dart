...
class AppThemes {
  ...
  static const Color _darkSubTextColor = Colors.white60;
...
//Text themes
  static const TextTheme _lightTextTheme = TextTheme(
    ...
    bodyMedium: TextStyle(fontSize: 14, color: _lightSubTextColor),
  ...
  static const TextTheme _darkTextTheme = TextTheme(
    ...
    bodyMedium: TextStyle(fontSize: 14, color: _darkSubTextColor),
    labelLarge: TextStyle(
      fontSize: 14,
      color: _darkTextColor,
      fontWeight: FontWeight.w500,
