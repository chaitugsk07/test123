...
class RssFeedServicesFeed {
  ...
  Future<List<SynopseArticlesTV4ArticleGroupsL2Detail>> gettagAll(
    ...
    const String query = '''
    query MyQuery(\$limit: Int = 10, \$offset: Int = 0, \$ai_tags: [String!] = "") {
    synopse_articles_t_v4_article_groups_l2_detail(order_by: {created_at: desc}, where: {group_ai_tags_l2: {_in: \$ai_tags}}, limit: \$limit, offset: \$offset) {
      article_group_id
      title
      image_urls
      logo_urls
