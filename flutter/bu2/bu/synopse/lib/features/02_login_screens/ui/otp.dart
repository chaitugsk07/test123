                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Animate(
                      ...
                      child: Text(
                        translation(context).enterOTPCode,
                      ...
                      child: Center(
                        child: SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            child: Text(
                              translation(context).editPhoneNo,
                              style: MyTypography.t12.copyWith(
                                fontSize: 18,
                                color: Theme.of(context)
                                    .colorScheme
                    ...
                    if (_secondsRemaining > 0)
                      Animate(
                        ...
                        child: Text(
                          translation(context).resendSeconds(_secondsRemaining),
                          style: MyTypography.t12.copyWith(
                            fontSize: 15,
                            color: Theme.of(context)
                                .colorScheme
                      ...
                      child: Container(
                        ...
                        child: RichText(
                          ...
                          text: TextSpan(
                            ...
                            children: [
                              TextSpan(text: translation(context).help1),
                              const TextSpan(
                                text: "support@synopse.news ",
                                style: TextStyle(color: Colors.red),
                              ),
                              TextSpan(text: translation(context).help2),
                              TextSpan(
                                text: translation(context).help3,
                                style: const TextStyle(color: Colors.red),
                              ),
                              TextSpan(text: translation(context).help4),
                              TextSpan(
                                text: translation(context).help5,
                                style: const TextStyle(color: Colors.red),
                              ),
                            ],
                          ),
