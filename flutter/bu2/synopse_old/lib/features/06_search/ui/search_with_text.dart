...
import 'package:synopse/features/06_search/bloc/search_last3_with_text/search_last3_with_text_bloc.dart';
      ...
      body: SafeArea(
        child: Column(
          children: [
                  ...
                  child: TextField(
                    ...
                    onSubmitted: (value) {
                      context.read<UserEventBloc>().add(
                          UserEventArticleSearchWithText(searchText: value));
                      context.push(searchResultswithText, extra: value);
                    },
                    autofocus: true,
            ...
            BlocBuilder<SearchLast3WithTextBloc, SearchLast3WithTextState>(
              ...
              if (searchLast3WithTextState.status ==
                ...
                return Column(
                  children: [
                    if (searchLast3WithTextState
                        .synopseRealtimeTTempUserSearchWithText.isNotEmpty)
                      Column(
                        children: [
                          const Padding(
                          ...
                          ListView.builder(
                            ...
                            itemCount: searchLast3WithTextState
                                .synopseRealtimeTTempUserSearchWithText.length,
