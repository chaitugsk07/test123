...
class _UserState extends State<User> {
  ...
  Future<bool> uploadImage(String filename) async {
    const url =
        'https://acceptable-etty-chaitugsk07.koyeb.app/upload/profilepic';
              ...
              if ((widget.username != _usernameController.text &&
                ...
                showDialog(
                  ...
                  builder: (BuildContext context) {
                    return BlocProvider<UserEventBloc>(
                      create: (BuildContext context) => UserEventBloc(
                        rssFeedServices: RssFeedServicesFeed(
                          GraphQLService(),
                        ),
                      ),
                      child: AlertDialog(
                        ...
                        content: Text(
                          'There are changes made to profile. To save the changes please submit, else click on ignore changes.',
