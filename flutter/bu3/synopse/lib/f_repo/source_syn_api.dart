...
class RssFeedServicesFeed {
  ...
  Future<List<SynopseArticlesTV4ArticleGroupsL2Detail>> getAll(
    ...
    query MyQuery(\$limit: Int!, \$offset: Int!, \$views: Int!) {
      synopse_articles_t_v4_article_groups_l2_detail(order_by: {post_published: desc}, limit: \$limit, offset: \$offset, where: {logo_urls: {_is_null: false}, t_user_article_views_aggregate: {count: {predicate: {_eq: \$views}}}}) {
        title
        image_urls
        logo_urls
        article_group_id
  ...
  Future<List<SynopseArticlesTV4ArticleGroupsL2DetailInShorts>> getAllInShorts(
    int limit,
    int offset,
    List<String> aiTags,
  ) async {
    const String query = '''
    query MyQuery(\$group_ai_tags_l3: [String!] = ["Social Issues", "automobile"], \$limit: Int = 10, \$offset: Int = 10) {
      synopse_articles_t_v4_article_groups_l2_detail(order_by: {post_published: desc}, limit: \$limit, where: {logo_urls: {_is_null: false}, image_urls: {_neq: []}, t_user_article_inshort_views_aggregate: {count: {predicate: {_eq: 0}}}, group_ai_tags_l3: {_in: \$group_ai_tags_l3}}, offset: \$offset) {
        title
        image_urls
        logo_urls
        article_group_id
  ...
  ''';
    ...
    if (response is Success) {
      ...
      final searchArticles = data
          .map((dynamic e) =>
              SynopseArticlesTV4ArticleGroupsL2DetailInShorts.fromJson(
                  e as Map<String, dynamic>))
          .toList();
      return searchArticles;
    } else {
  ...
  Future<List<SynopseArticlesTV4ArticleGroupsL2DetailInShorts>>
      getAllInShortsNO(
    int limit,
    int offset,
  ) async {
    ...
    query MyQuery( \$limit: Int = 10, \$offset: Int = 10) {
      synopse_articles_t_v4_article_groups_l2_detail(order_by: {post_published: desc}, limit: \$limit, where: {logo_urls: {_is_null: false}, image_urls: {_neq: []}, t_user_article_inshort_views_aggregate: {count: {predicate: {_eq: 0}}}}, offset: \$offset) {
        title
        image_urls
        logo_urls
        article_group_id
  ...
  Future<List<SynopseArticlesTV4ArticleGroupsL2DetailInShorts>>
    ...
    const String query = '''
    query MyQuery(\$group_ai_tags_l3: [String!] = ["Social Issues", "automobile"], \$limit: Int = 10, \$offset: Int = 10) {
      synopse_articles_t_v4_article_groups_l2_detail(order_by: {post_published: desc}, limit: \$limit, where: {logo_urls: {_is_null: false}, image_urls: {_neq: []}, t_user_article_inshort_views_aggregate: {count: {predicate: {_eq: 0}}}, group_ai_tags_l3: {_nin: \$group_ai_tags_l3}}, offset: \$offset) {
        title
        image_urls
        logo_urls
        article_group_id
  ...
  Future<List<SynopseArticlesTV4ArticleGroupsL2Detail>> getArticleForComment(
    int articlegroupId,
  ) async {
    const String query = '''
    query MyQuery(\$article_group_id: bigint!) {
      synopse_articles_t_v4_article_groups_l2_detail(where: {logo_urls: {_is_null: false}, article_group_id: {_eq: \$article_group_id}}) {
        title
        image_urls
        logo_urls
        article_group_id
  ...
  Future<List<SynopseArticlesTV4ArticleGroupsL2Detail>> getAllLiked(
    ...
    query MyQuery(\$limit: Int!, \$offset: Int!, \$account: uuid!) {
      synopse_articles_t_v4_article_groups_l2_detail(order_by: {post_published: desc}, limit: \$limit, offset: \$offset, where: {logo_urls: {_is_null: false}, ext_user_likes: {account: {_eq: \$account}}}) {
        title
        image_urls
        logo_urls
        article_group_id
  ...
  Future<List<SynopseArticlesTV4ArticleGroupsL2Detail>> getAllBookmarked(
    ...
    query MyQuery(\$limit: Int!, \$offset: Int!) {
      synopse_articles_t_v4_article_groups_l2_detail(order_by: {post_published: desc}, limit: \$limit, offset: \$offset, where: {logo_urls: {_is_null: false}, t_user_article_bookmarks_aggregate: {count: {predicate: {_eq: 1}}}}) {
        title
        image_urls
        logo_urls
        article_group_id
  ...
  Future<List<SynopseArticlesTV4ArticleGroupsL2Detail>> gettagAll(
    ...
    const String query = '''
    query MyQuery(\$limit: Int!, \$offset: Int!, \$ai_tags: String!) {
    synopse_articles_t_v4_article_groups_l2_detail(order_by: {post_published: desc}, where: {group_ai_tags_l3: {_eq: \$ai_tags}}, limit: \$limit, offset: \$offset) {
      article_group_id
      title
      image_urls
      logo_urls
  ...
  Future<List<SynopseArticlesTV4ArticleGroupsL2Detail>> gettagAllSideScroll(
    int limit,
    int offset,
    String tag,
  ) async {
    const String query = '''
    query MyQuery(\$limit: Int!, \$offset: Int!, \$ai_tags: String!) {
    synopse_articles_t_v4_article_groups_l2_detail(order_by: {post_published: desc}, where: {group_ai_tags_l3: {_eq: \$ai_tags}, image_urls: {_neq: []}}, limit: \$limit, offset: \$offset) {
      article_group_id
      title
      image_urls
      logo_urls
  ...
  Future<List<SynopseRealtimeVV10UsersFollowUp>> getAllFollowUps(
    int articleGroupId,
  ) async {
    const String query = '''
    query MyQuery(\$article_group_id: bigint!) {
      synopse_realtime_v_v10_users_follow_up(order_by: {updated_at: desc}, where: {article_group_id: {_eq: \$article_group_id}}) {
        query
        reply
      }
    }
  ''';
    ...
    if (response is Success) {
      final data =
          response.data?['synopse_realtime_v_v10_users_follow_up'] as List;
      //log("SUCCESS DATA:${response.data.toString()}");
      final searchArticles = data
          .map((dynamic e) => SynopseRealtimeVV10UsersFollowUp.fromJson(
              e as Map<String, dynamic>))
          .toList();
      return searchArticles;
    } else {
  ...
  Future<int> fetFollowUpLatest(
    int articleGroupId,
  ) async {
    const String query = '''
      query MyQuery(\$article_group_id: bigint!) {
      synopse_realtime_t_v10_users_follow_up(limit: 1, order_by: {updated_at: desc}, where: {article_group_id: {_eq: \$article_group_id}}) {
        id
      }
    }
  ''';
    ...
    if (response is Success) {
      final data =
          response.data?['synopse_realtime_t_v10_users_follow_up'] as List;
      if (data.isNotEmpty) {
  ...
  Future<List<SynopseRealtimeVUserArticleCommentUser>> getUserComments(
    ...
    query MyQuery(\$limit: Int!, \$offset: Int!, \$account: uuid!) {
      synopse_realtime_v_user_article_comments(limit: \$limit, offset: \$offset, where: {account: {_eq: \$account}}) {
        ...
        account
        article_group_id
        article_comment_dislikes_aggregate {
          aggregate {
            count
          }
        }
        article_comment_likes_aggregate {
          aggregate {
            count
          }
        }
  ...
  Future<String> setArticleGroupViewInShort(
    int articleGroupId,
  ) async {
    const String query = '''
    mutation MyMutation(\$article_group_id: bigint = "") {
      insert_synopse_realtime_t_user_article_inshort_view_one(object: {article_group_id: \$article_group_id}) {
        id
      }
    }
  ''';
  ...
  Future<String> updateReply(
    ...
    const String query = '''
    mutation MyMutation(\$reply: String = "", \$followUpId: bigint = "") {
      update_synopse_realtime_t_v10_users_follow_up(where: {id: {_eq: \$followUpId}}, _set: {reply: \$reply}) {
        affected_rows
      }
    }
  ''';
