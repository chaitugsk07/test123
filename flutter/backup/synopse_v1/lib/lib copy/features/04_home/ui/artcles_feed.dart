...
import 'package:synopse_v001/features/04_home/bloc/set_like_view_comment/set_like_view_comment_bloc.dart';
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            if (isLoggedIn && isliked == 0)
                              GestureDetector(
                                onTap: () {
                                  context.read<SetLikeViewCommentBloc>().add(
                                      SetLikeViewCommentEventSetLike(
                                          action: 'InsertLike',
                                          articleGroupId: state
                                              .articlesTV1ArticalsGroupsL1Detail[
                                                  index]
                                              .articleGroupId));
