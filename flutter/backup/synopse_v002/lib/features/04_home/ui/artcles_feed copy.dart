                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            if (state.articlesTV1ArticalsGroupsL1Detail[index]
                                    .articleGroupsL1ToLikes!.likeCount >
                                0)
                              Row(
                                children: [
                            ...
                            if (state.articlesTV1ArticalsGroupsL1Detail[index]
                                    .articleGroupsL1ToComments!.commentCount >
                                0)
                              Row(
                                children: [
                                  const SizedBox(width: 4),
                            ...
                            if (state.articlesTV1ArticalsGroupsL1Detail[index]
                                    .articleGroupsL1ToViews!.viewCount >
                                0)
                              Row(
                                children: [
                                  const SizedBox(width: 6),
