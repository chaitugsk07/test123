    ...
    articlesDetailBloc.stream.listen(
      (state) {
        if (state.status == ArticlesRss1StatusDetail.success) {
          ...
          var comments = state.articlesTV1ArticalsGroupsL1DetailSummary[0]
                    ...
                    case 0:
                      context.push(comments,
                          extra: articleDetailState
                              .articlesTV1ArticalsGroupsL1DetailSummary[index]
                              .articleGroupId);
                      break;
                    case 1:
                      setState(() {
                ...
                child: Animate(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      ...
                      articleDetailState
                          .articlesTV1ArticalsGroupsL1DetailSummary[0].title,
                      style: Theme.of(context)
                          .textTheme
                          .titleLarge
              ...
              Animate(
                ...
                child: ImageCarousel(
                  imageUrls: articleDetailState
                      .articlesTV1ArticalsGroupsL1DetailSummary[0].imageUrls,
                  height: 200,
                  aspectRatio: 16 / 9,
              ...
              Animate(
                ...
                child: Padding(
                  ...
                  child: Text(
                    ...
                    articleDetailState
                        .articlesTV1ArticalsGroupsL1DetailSummary[0].summary,
                    style: Theme.of(context)
                        .textTheme
                        .bodyMedium
